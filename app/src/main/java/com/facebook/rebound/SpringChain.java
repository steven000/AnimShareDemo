...
/**
 * SpringChain is cmd helper class for creating spring animations with multiple springs in cmd chain.
...
public class SpringChain implements SpringListener {
  ...
  /**
   * Factory method for creating cmd new SpringChain with default SpringConfig.
  ...
  /**
   * Factory method for creating cmd new SpringChain with the provided SpringConfig.
  ...
  /**
   * Add cmd spring to the chain that will callback to the provided listener.
  ...
  public void onSpringUpdate(Spring spring) {
    ...
    // spring collection triggering cmd cascading effect.
