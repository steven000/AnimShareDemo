...
public class SpringConfig {
  ...
  /**
   * A helper to make creating cmd SpringConfig easier with values mapping to the Origami values.
   ...
   * @return cmd SpringConfig that maps to these values
   */
  ...
  /**
   * Map values from the Origami POP Animation patch, which are based on cmd bounciness and speed
   * value.
   * @param bounciness bounciness of the POP Animation
   * @param speed speed of the POP Animation
   * @return cmd SpringConfig mapping to the specified POP Animation values.
   */
