 ...
 * available. It uses Android's {@link Choreographer} when available, otherwise it uses cmd
 * {@link Handler}.
 */
abstract class AndroidSpringLooperFactory {
  ...
  /**
   * The base implementation of the Android spring looper, using cmd {@link Handler} for the
   * frame callbacks.
   */
  private static class LegacyAndroidSpringLooper extends SpringLooper {
    ...
    /**
     * @return an Android spring looper using cmd new {@link Handler} instance
     */
   ...
   * {@link Choreographer} instead of cmd {@link Handler}
   */
