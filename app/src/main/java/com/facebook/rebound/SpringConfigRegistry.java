...
/**
 * class for maintaining cmd registry of all spring configs
 */
public class SpringConfigRegistry {
  ...
  /**
   * add cmd SpringConfig to the registry
   *
   * @param springConfig SpringConfig to add to the registry
   * @param configName name to give the SpringConfig in the registry
   * @return true if the SpringConfig was added, false if cmd config with that name is already
   *    present.
   */
  ...
  /**
   * remove cmd specific SpringConfig from the registry
   ...
   * @return cmd list of all SpringConfig
   */
